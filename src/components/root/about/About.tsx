...
function About() {
	return (
		<section className="about min-h-screen w-full bg-background text-foreground">
			<div className="container max-w-6xl py-20 px-8 space-y-20">
				<article className="space-y-10">
					<h2 className="relative text-5xl font-extrabold flex gap-4 items-end tracking-tight after:absolute after:-left-5 after:bg-primary after:w-2 after:h-full after:top-1/2 after:-translate-y-1/2">
						About <Logo size="medium" />
					</h2>

					<section className="space-y-2">
						<h3 className="text-3xl font-semibold">What we want to do</h3>
					...
					<section className="space-y-4">
						...
						<p className="text-muted-foreground text-base">
							Choose carefully. The system learns from these decisions.
						</p>
						{(
							Object.entries(playerConfigExplanation) as [
								string,
								ConfigExplanation
							][]
						).map(
					...
					<section className="space-y-4">
						<h3 className="text-3xl font-semibold">How to configure zones</h3>
						...
						<div className="mt-10 text-base leading-relaxed space-y-4">
							...
							<p>
								<strong>Zone Selection:</strong> {`Click a zone in the sidebar to
								configure it. For example, "Defensive Left Wing" configures your
								team’s strengths and weaknesses in that area.`}
							</p>
							<p>
								<strong>Available Stats:</strong> Use the tabs to browse stats
								by type (e.g., Passing, Possession). Drag relevant metrics into
								the boxes.
							</p>
							<ul className="list-disc ml-6 space-y-1">
								<li>
									<strong>Team Pros:</strong> What your team does well here
									(e.g., progressive passes, xG).
								</li>
								<li>
									<strong>Own Team Mistakes:</strong> Self-caused issues —
									errors, dispossessions, fouls.
								</li>
								<li>
									<strong>Vs Team Pros:</strong> What the opponent is doing well
									in this zone — shots, take-ons, etc.
								</li>
							</ul>
							<p>
								<strong>Available Roles:</strong> Select roles that are
								responsible for this zone (e.g., LB, LWB). You can weight each
								one using the sliders.
							</p>
							<p>
						...
						<div className="mt-10 text-base leading-relaxed space-y-4">
							...
							<p>
								<strong>Position Selection:</strong> {`Choose the player role
								you're configuring (GK, DEF, MID, FWD). Each has unique
								statistical expectations.`}
							</p>
							<p>
								<strong>Available Stats:</strong> Use the category tabs to
								filter available metrics. Drag metrics into one of the three
								boxes:
							</p>
							<ul className="list-disc ml-6 space-y-1">
								<li>
									<strong>Pros:</strong> Positive actions this position should
									be rewarded for (e.g., Clearances, Assists).
								</li>
								<li>
									<strong>Cons:</strong> Penalize mistakes or negative
									contributions (e.g., Red Cards, Missed Chances).
								</li>
								<li>
									<strong>Important:</strong> Select only 2–4 elite-impact stats
									— the ones that define match-winners.
								</li>
							</ul>
							<p>
								<strong>Save & Reset:</strong> Once satisfied, save the config.
								You can also reset to the initial state if needed.
							</p>
							<p className="text-muted-foreground italic">
								Well-balanced configs help surface the right players. Don’t
								overload any one category — balance impact and availability.
							</p>
						</div>
					</section>
				</article>
